							...
							<div className="flex-1 min-w-0">
								...
								<div className="flex items-center gap-4 mb-4">
									<div className="text-lg font-semibold text-gray-700">
										Цена: {item.price.toFixed(2)} ₽ за {item.unit === 'т' ? 'тонну' : 'метр'}
									</div>
								...
								<div className="flex items-center gap-3">
									...
									<span className="w-16 text-center font-bold text-lg bg-gray-100 rounded-xl py-2">{item.quantity} {item.unit === 'т' ? 'т' : 'м'}</span>
									<button 
